...
from Samplers import SimplexDiffusionSampler
from Experiments import SimplexDiffusionExperiment
...
if __name__ == "__main__":
    ...
    exp = SimplexDiffusionExperiment(model,tokenizer, sampler,dl, RESULT_PATH, T, SEQ_LEN,vocab_size, epochs= N_EPOCHS, alphas=alphas)
    exp.run()